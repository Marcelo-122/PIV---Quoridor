...
from src.core.constantes import COR_MSG_VITORIA, COR_MSG_ERRO, LARGURA, ALTURA
...
def draw_game(
    ...
    # Usar tamanho real do tabuleiro em vez de constantes fixas
    linhas = jogo.linhas
    ...
    turno_str = f"Turno: Jogador {jogador_atual + 1}" if not jogo.jogo_terminado else "Fim de Jogo"
